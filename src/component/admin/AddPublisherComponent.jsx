...
const AddPublisherComponent = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      message.error("Error adding publisher!");
    }
  };
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-2xl font-semibold text-blue-500">Add Publisher</h1>
      <div className="grid grid-cols-3 gap-4 p-4">
        <Form form={form} layout="vertical" onFinish={onFinish}>
          <Form.Item
            name="publisherName"
            label="Publisher Name"
            rules={[{ required: true, message: "Please input the publisher name!" }]}
          >
            <Input />
          </Form.Item>
          <Form.Item
